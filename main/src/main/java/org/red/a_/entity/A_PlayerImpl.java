...
public class A_PlayerImpl extends A_LivingEntityImpl implements A_Player {
    ...
    private EntityHideManager entityHideManager;
    public A_PlayerImpl(Player player, A_OfflinePlayer aOfflinePlayer, A_ManagerImpl.A_Version aVersion) {
        ...
        skinManager = NmsFactory.createSkinManager(this);
    ...
    public EntityHideManager getEntityHideManager() {
        return entityHideManager;
    }

    @Override
    public void hideEntity(Entity entity) {
        entityHideManager.hide(entity);
    }

    @Override
    public boolean isHiddenEntity(Entity entity) {
        return entityHideManager.isHidden(entity);
    }

    @Override
    public void showEntity(Entity entity) {
        entityHideManager.show(entity);
    }

    @Override
    public void setSkin(String skin, String signature) {
        skinManager.setSkin(skin, signature);
    }
    ...
    public boolean isChangedSkin() {
        return skinManager.isChangedSkin();
    }
